...
// snake_case (env_required) so hydration from the boot payload/API response is
// a straight pass-through with no remapping.
...
export type AuthSliceActions = {
  ...
  /** Mark the session unauthenticated without touching mode/env_required.
