...
export const settingsQueryOptions = {
  ...
  userSettings: () =>
    queryOptions({
      ...
      queryFn: () =>
        fetchUserSettings({ cache: "no-store" }).then((r) => mapUserSettingsResponse(r)),
      staleTime: 5 * 60_000,
    }),
  ...
  systemHealth: () =>
    queryOptions({
      ...
      refetchInterval: 5 * 60_000, // restore #1195 periodic poll
      refetchOnWindowFocus: true, // restore #1195 visibility refetch (overrides global default refetchOnWindowFocus:false)
    }),
