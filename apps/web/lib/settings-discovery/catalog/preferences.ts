...
export const PREFERENCES_DISCOVERY_DEFINITIONS: SettingsDiscoveryDefinition[] = [
  ...
  },
  {
    ...
    groupId: "preferences",
    href: TASK_BEHAVIOR_SETTINGS_HREF,
    targetId: GENERAL_SETTINGS_TARGETS.voiceEnable,
    order: 68,
  },
  {
    id: "voice-engine",
    ...
    groupId: "preferences",
    href: TASK_BEHAVIOR_SETTINGS_HREF,
    targetId: GENERAL_SETTINGS_TARGETS.voiceEngine,
    order: 69,
  },
  {
    id: "voice-behavior",
    ...
    groupId: "preferences",
    href: TASK_BEHAVIOR_SETTINGS_HREF,
    targetId: GENERAL_SETTINGS_TARGETS.voiceBehavior,
    order: 70,
  },
  {
    id: "voice-model",
    ...
    groupId: "preferences",
    href: TASK_BEHAVIOR_SETTINGS_HREF,
    targetId: GENERAL_SETTINGS_TARGETS.voiceModel,
    order: 71,
  },
  {
    id: "voice-shortcut",
    ...
    groupId: "preferences",
    href: TASK_BEHAVIOR_SETTINGS_HREF,
    targetId: GENERAL_SETTINGS_TARGETS.voiceShortcut,
    order: 72,
  },
];
