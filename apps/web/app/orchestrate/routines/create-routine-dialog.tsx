    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-lg">
        ...
        <div className="space-y-4">
          <div>
            <Label>Name</Label>
            <Input value={name} onChange={(e) => setName(e.target.value)} placeholder="Daily Dep Update" />
          </div>
          <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <Select value={assignee} onValueChange={setAssignee}>
                <SelectTrigger className="cursor-pointer"><SelectValue placeholder="Select agent" /></SelectTrigger>
                <SelectContent>
                  {agents.map((a) => (
            ...
            <div>
              ...
              <Select value={concurrency} onValueChange={setConcurrency}>
                ...
                <SelectContent>
                  <SelectItem value="skip_if_active" className="cursor-pointer">Skip if active</SelectItem>
                  <SelectItem value="coalesce_if_active" className="cursor-pointer">Coalesce</SelectItem>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <Select value={triggerKind} onValueChange={setTriggerKind}>
                <SelectTrigger className="cursor-pointer"><SelectValue /></SelectTrigger>
                <SelectContent>
                  <SelectItem value="cron" className="cursor-pointer">Cron</SelectItem>
        ...
        <DialogFooter>
          ...
          <Button onClick={handleSubmit} disabled={!name} className="cursor-pointer">Create</Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
  );
