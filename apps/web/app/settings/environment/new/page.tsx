      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="space-y-2">
            ...
            <Select
              value={baseImage}
              onValueChange={(value) => onBaseImageChange(value as BaseDocker)}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <div className="space-y-2">
            ...
            <Input
              id="image-tag"
              value={imageTag}
              onChange={(event) => onImageTagChange(event.target.value)}
            />
          </div>
        </div>
      </CardContent>
    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex items-center justify-between flex-wrap gap-2">
          ...
          <Button type="button" onClick={onBuildImage}>
            Build image
          </Button>
        </div>
        {showDockerfileEditor && (
  ...
  const handleCreate = async () => {
    ...
    try {
      const payload = {
        ...
        image_tag: imageTag,
        dockerfile,
        build_config: { base_image: baseImage, install_agents: installAgents.join(",") },
      };
  ...
  return (
    <div className="space-y-8">
      ...
      <ImageBuildCard
        ...
        showDockerfileEditor={showDockerfileEditor}
