...
export function TasksPageClient({
  ...
  const { activeWorkspaceId, activeWorkflowId, repositories: storeRepositories } =
  ...
  const { pageCount, columns, handleRowClick, defaultWorkflow, defaultStep } = useTasksPageComputed({
    total,
    pagination,
    workflows,
    steps,
