...
export const dummyMessages: Message[] = [
  // Task description
  { ...B, id: 'task-description', content: '[TASK DESCRIPTION - AMBER BANNER] Implement a new feature to handle user authentication with OAuth 2.0', author_type: 'user', type: 'message', created_at: '2024-01-20T10:00:00Z' },

  // User message - short
  { ...B, id: 'user-1', content: '[USER MESSAGE - SHORT] Can you help me with this?', author_type: 'user', type: 'message', created_at: '2024-01-20T10:01:00Z' },

  // User message - long
  { ...B, id: 'user-2', content: '[USER MESSAGE - LONG] I need to implement a complex feature that involves multiple components. The requirements are:\n1. User authentication\n2. Role-based access control\n3. Session management\n4. Token refresh mechanism\n\nCan you help me design this system?', author_type: 'user', type: 'message', created_at: '2024-01-20T10:02:00Z' },

  // Agent message - plain text
  { ...B, id: 'agent-1', content: '[AGENT MESSAGE - PLAIN TEXT] This is a simple paragraph with no markdown formatting. Just plain text content.', author_type: 'agent', type: 'message', created_at: '2024-01-20T10:03:00Z' },
