...
export function TasksList() {
  ...
  // WS-driven invalidation flows through the office TQ bridge
  // (`lib/query/bridge/office.ts`), which invalidates the paginated cache
  // key on task lifecycle events so this `useInfiniteQuery` refetches.
