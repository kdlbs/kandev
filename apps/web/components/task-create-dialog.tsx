...
function useDialogFormState(
  open: boolean,
  workspaceId: string | null,
  workflowId: string | null,
  initialValues?: TaskCreateDialogProps["initialValues"],
) {
...
function useRepositoryAutoSelectEffect(
  fs: DialogFormState,
  open: boolean,
  workspaceId: string | null,
...
function useDiscoverReposEffect(
  fs: DialogFormState,
  open: boolean,
  workspaceId: string | null,
...
function useLocalBranchesEffect(
  fs: DialogFormState,
  open: boolean,
  workspaceId: string | null,
  toast: ReturnType<typeof useToast>["toast"],
...
function computeEffectiveStepId(
...
export function TaskCreateDialog({
  ...
  const { handleSubmit, handleUpdateWithoutAgent, handleCreateWithoutAgent, handleCancel } =
    useTaskSubmitHandlers({
      ...
      setEnvironmentId: fs.setEnvironmentId,
      ...
      <DialogContent className="w-full h-full max-w-full max-h-full rounded-none sm:w-[900px] sm:h-auto sm:max-w-none sm:max-h-[85vh] sm:rounded-lg flex flex-col">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4 overflow-hidden">
          <DialogFormBody
            ...
            workflows={workflows}
            snapshots={snapshots}
            effectiveWorkflowId={effectiveWorkflowId ?? null}
            fs={fs}
