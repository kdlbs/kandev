...
import {
  ...
  IconMessagePlus, IconArrowsDiff, IconRefresh,
...
function WrapButton({ wrapEnabled, onToggleWrap }: { wrapEnabled: boolean; onToggleWrap: () => void }) {
...
export function MonacoEditorToolbar({
  ...
  commentCount, hasRemoteUpdate = false, hasVcsDiff = false, lspStatus, lspLanguage,
  onToggleLsp, onToggleWrap, onToggleDiffIndicators, onSave, onReloadFromAgent, onDelete,
    ...
    <PanelHeaderBarSplit
      ...
      right={
        <div className="flex items-center gap-1">
          <CommentCountBadge enableComments={enableComments} sessionId={sessionId} commentCount={commentCount} />
          ...
          <ReloadFromAgentButton hasRemoteUpdate={hasRemoteUpdate} onReloadFromAgent={onReloadFromAgent} />
