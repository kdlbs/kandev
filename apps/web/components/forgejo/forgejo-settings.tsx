...
import { deleteForgejoActionPreset, deleteForgejoConfig, deleteForgejoIssueWatch, deleteForgejoReviewWatch, getForgejoConfig, listForgejoActionPresets, listForgejoIssueWatches, listForgejoQueue, listForgejoRepositories, listForgejoReviewWatches, pollForgejoIssueWatch, refreshForgejoConnection, saveForgejoActionPreset, saveForgejoIssueWatch, saveForgejoReviewWatch, setForgejoConfig, testForgejoConfig } from "@/lib/api/domains/forgejo-api";
import type { ForgejoActionPreset, ForgejoConfig, ForgejoIssueWatch, ForgejoRepository, ForgejoReviewWatch } from "@/lib/types/forgejo";
...
function ForgejoConnection({ workspaceId }: { workspaceId: string }) {
  ...
  const save = async () => { const next = await setForgejoConfig({ origin, token: token || undefined, webhook_secret: webhookSecret || undefined }, options); setConfig(next); setToken(""); setWebhookSecret(""); setMessage(`Saved connection for ${next.username}`); };
