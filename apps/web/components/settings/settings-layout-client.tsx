        ...
        <SettingsTargetProvider>
          <main className="flex min-h-0 flex-1 flex-col">
            ...
            <div
              ...
              className="flex min-w-0 min-h-0 flex-1 flex-col gap-4 overflow-y-auto overscroll-contain p-4 pb-[calc(13rem_+_env(safe-area-inset-bottom)_+_var(--app-status-bar-height))]"
            >
              {children}
            </div>
          </main>
