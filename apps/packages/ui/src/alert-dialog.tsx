...
function AlertDialogTitle({
  ...
  return (
    <AlertDialogPrimitive.Title
      ...
      className={cn(
        "min-w-0 text-sm font-medium text-balance wrap-break-word sm:group-data-[size=default]/alert-dialog-content:group-has-data-[slot=alert-dialog-media]/alert-dialog-content:col-start-2",
        className,
      )}
      {...props}
    />
...
function AlertDialogDescription({
  ...
  return (
    <AlertDialogPrimitive.Description
      ...
      className={cn(
        "text-muted-foreground min-w-0 *:[a]:hover:text-foreground text-xs/relaxed text-pretty wrap-break-word *:[a]:underline *:[a]:underline-offset-3",
        className,
      )}
      {...props}
    />
