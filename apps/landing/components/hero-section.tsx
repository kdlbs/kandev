...
export function HeroSection() {
  ...
  return (
    <section className="relative overflow-hidden">
      {/* Animated gradient cloud */}
      <div className="absolute inset-0 -z-10 flex items-center justify-center">
        <div
          className="absolute w-[800px] h-[800px] rounded-full filter blur-3xl opacity-60 animate-pulse-slow"
          style={{
            background: 'radial-gradient(circle, rgba(133, 110, 232, 0.3) 0%, rgba(177, 140, 254, 0.15) 40%, transparent 70%)'
          }}
        />
      </div>
      <div className="container mx-auto max-w-6xl flex flex-col items-center gap-8 px-4 pt-32 pb-16 md:pt-40 md:pb-24">
