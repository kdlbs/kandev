...
- show_rich_output_kandev: Render one bounded Kandev-native file preview, metric group, line chart, bar chart, or CSV-backed time series/comparison. You MUST use it when the user explicitly asks for a chart, graph, plot, or file preview and suitable data is available. Prefer prose for ordinary answers and a Markdown table for small textual comparisons. Inline chart recipe: {"type":"chart","chart_type":"bar","title":"...","summary":"...","labels":["A","B"],"series":[{"label":"Count","values":[42,27]}]}; switch chart_type to line for trends. For a workspace CSV, use this CSV chart recipe: {"type":"chart","chart_type":"line","title":"...","summary":"...","csv":{"path":"reports/latency.csv","x_column":"recorded_at","series":[{"column":"p95_ms","label":"p95 (ms)"}]}}. Paths must be task-workspace-relative. Kandev owns axes and legends; do not send data, categories, x_axis, or y_axis. Give each series a clear display label and include its unit when useful; Kandev renders visible axes, tooltips, and local multi-series legend controls. Required params: version (must be 1), title, blocks (1-4 file, chart, or metrics blocks). Never embed bytes, URLs, HTML, JavaScript, CSS, or layout instructions.
