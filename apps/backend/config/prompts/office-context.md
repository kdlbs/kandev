...
- get_github_rate_limit_kandev: Read Kandev's local GitHub rate-limit observations and admission state for this task's workspace without making a provider request.
