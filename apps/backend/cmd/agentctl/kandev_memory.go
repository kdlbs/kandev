...
func memoryGet(args []string) int {
	...
	path := fmt.Sprintf("/api/v1/orchestrate/agents/%s/memory", agentID)
...
func memorySet(args []string) int {
	...
	path := fmt.Sprintf("/api/v1/orchestrate/agents/%s/memory", client.agentID)
...
func memorySummary(args []string) int {
	...
	path := fmt.Sprintf("/api/v1/orchestrate/agents/%s/memory/summary", client.agentID)
