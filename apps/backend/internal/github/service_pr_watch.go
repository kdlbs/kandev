...
func (s *Service) SyncTaskPR(ctx context.Context, taskID string, status *PRStatus) error {
	...
	return s.persistAndPublishTaskPRSync(ctx, tp, status, changed, status.OutcomeFieldsPopulated)
}
...
func (s *Service) persistAndPublishTaskPRSync(ctx context.Context, tp *TaskPR, status *PRStatus, changed, outcomeFieldsPopulated bool) error {
