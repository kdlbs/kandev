...
func TestClearToken(t *testing.T) {
	...
	// Add a GITHUB_TOKEN secret
	mgr.Create(context.Background(), "GITHUB_TOKEN", "ghp_toberemoved")
	...
	// Verify auth method was reset
	if svc.authMethod != AuthMethodNone {
		t.Errorf("expected authMethod to be reset to %q, got %q", AuthMethodNone, svc.authMethod)
	}
}
