...
func TestProfileContractFieldsAreUniqueAndClassified(t *testing.T) {
	...
	for _, required := range []string{"name", "model", "fallback_model", "auto_fallback", "mode", "config_options", "cli_flags", "env_vars", "command_prefix", "provider_kind", "provider_base_url", "provider_api_key_secret_id", "enabled"} {
