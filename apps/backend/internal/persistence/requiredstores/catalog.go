...
var catalog = []Descriptor{
	...
	{ID: storeIDTask, OwnerPackage: "internal/task/repository/sqlite", RequiredTables: []string{"workspaces", "tasks", "task_workflow_session_bindings", "task_environment_kubernetes", "harness_session_generations", "session_restore_attempts", "session_continuation_snapshots", "session_recovery_blocks", "agent_delivery_submissions", "agent_delivery_inbox", "agent_delivery_cursors", "agent_delivery_effects"}, DependsOn: []string{storeIDSchemaMeta}, Capabilities: []Capability{CapabilityBoolean, CapabilityTimestamp, CapabilityConflict, CapabilityTransaction}, Sweep: startup.StepStoresRepositories},
