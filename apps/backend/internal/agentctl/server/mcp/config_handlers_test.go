...
func TestMoveTaskHandler_Success(t *testing.T) {
	...
	result := callTool(t, s, "move_task", map[string]interface{}{
		"task_id":          "task-1",
		"workflow_id":      "wf-1",
...
func TestMoveTaskHandler_MissingWorkflowID(t *testing.T) {
	backend := &testBackend{}
	s := newTestServer(t, backend)
...
func TestMoveTaskHandler_MissingStepID(t *testing.T) {
	backend := &testBackend{}
	s := newTestServer(t, backend)
...
func TestDeleteTaskHandler_Success(t *testing.T) {
	...
	result := callTool(t, s, "delete_task", map[string]interface{}{
		"task_id": "task-1",
	})
...
func TestArchiveTaskHandler_Success(t *testing.T) {
	backend := &testBackend{
		response: map[string]interface{}{"success": true},
	}
	s := newTestServer(t, backend)

	result := callTool(t, s, "archive_task", map[string]interface{}{
		"task_id": "task-1",
	})
