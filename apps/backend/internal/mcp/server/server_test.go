...
func TestServerModeTask_ToolCount(t *testing.T) {
	...
	// + 2 task-dependency (add/remove) + 1 rich-output + 1 GitHub rate snapshot = 39.
...
func TestServerModeOffice_ToolCount(t *testing.T) {
	...
	// + 1 rich-output + 1 decisions + 1 GitHub rate snapshot
	// + 1 step_complete (ADR 0015) = 13.
...
func TestServerModeOffice_DisableAskQuestion(t *testing.T) {
	...
	// + 1 decisions + 1 GitHub rate snapshot + 1 step_complete (ADR 0015) = 12
