...
var startupCatalog = []CatalogEntry{
	...
	{Key: "office.maxConcurrentInstance", EnvVars: []string{"KANDEV_OFFICE_MAX_CONCURRENT_INSTANCE"}, Owner: "office", Default: "8"},
	{Key: "office.maxConcurrentWorkspace", EnvVars: []string{"KANDEV_OFFICE_MAX_CONCURRENT_WORKSPACE"}, Owner: "office", Default: "4"},
	{Key: "office.workspaceBudgetPerHour", EnvVars: []string{"KANDEV_OFFICE_WORKSPACE_BUDGET_PER_HOUR"}, Owner: "office", Default: "120"},
	{Key: "office.routineBudgetPerHour", EnvVars: []string{"KANDEV_OFFICE_ROUTINE_BUDGET_PER_HOUR"}, Owner: "office", Default: "20"},
	{Key: "office.promotionAgeMinutes", EnvVars: []string{"KANDEV_OFFICE_PROMOTION_AGE_MINUTES"}, Owner: "office", Default: "15"},
	{Key: "office.maxCausationDepth", EnvVars: []string{"KANDEV_OFFICE_MAX_CAUSATION_DEPTH"}, Owner: "office", Default: "8"},
	{Key: "office.selfTriggerAllowance", EnvVars: []string{"KANDEV_OFFICE_SELF_TRIGGER_ALLOWANCE"}, Owner: "office", Default: "3"},
	{Key: "office.gateFailureThreshold", EnvVars: []string{"KANDEV_OFFICE_GATE_FAILURE_THRESHOLD"}, Owner: "office", Default: "3"},
