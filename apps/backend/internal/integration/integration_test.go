...
func NewTestServer(t *testing.T) *TestServer {
	...
	noteService := taskservice.NewNoteService(taskRepo, eventBus, log)
	taskhandlers.RegisterTaskRoutes(router, gateway.Dispatcher, taskSvc, nil, taskRepo, planService, noteService, log)
