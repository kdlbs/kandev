...
//nolint:gocognit,cyclop,funlen,maintidx // Legacy backend service-wiring orchestration predating startup-step instrumentation; split after launcher migration settles.
