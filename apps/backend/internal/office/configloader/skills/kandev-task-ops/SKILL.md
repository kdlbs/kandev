...
description: Operate Office tasks when you need to list workspace tasks, move or archive a task, read a conversation, or post an agent-authored comment.
kandev:
  system: true
  version: "0.42.0"
...
- List, move, archive, or read task conversations: read `references/tasks.md`.
