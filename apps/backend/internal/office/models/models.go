...
type Run struct {
	...
	// Causation chain identity (REQ-OFFICE-RUN-CAUSATION-001). CausationID
	// is the root run's own ID; empty means the legacy pre-capability
	// marker, read by AC-OFFICE-RUN-CAUSATION-001.6 as a root at depth 0.
