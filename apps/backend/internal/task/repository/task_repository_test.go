...
func TestSQLiteRepository_ListTasksByWorkspace(t *testing.T) {
	...
	tasks, total, err := repo.ListTasksByWorkspace(ctx, "ws-1", "", 1, 10, false, false, false)
	if err != nil {
	...
	// Test pagination
	tasks, total, err = repo.ListTasksByWorkspace(ctx, "ws-1", "", 1, 2, false, false, false)
	if err != nil {
	...
	// Test page 2
	tasksPage2, _, err := repo.ListTasksByWorkspace(ctx, "ws-1", "", 2, 2, false, false, false)
	if err != nil {
...
func TestSQLiteRepository_ListTasksByWorkspaceWithSearch(t *testing.T) {
	...
	_, totalAuth, err := repo.ListTasksByWorkspace(ctx, "ws-1", "authentication", 1, 10, false, false, false)
	if err != nil {
	...
	tasksDarkMode, totalDarkMode, err := repo.ListTasksByWorkspace(ctx, "ws-1", "dark mode", 1, 10, false, false, false)
	if err != nil {
	...
	tasksRepo, totalRepo, err := repo.ListTasksByWorkspace(ctx, "ws-1", "MyProject", 1, 10, false, false, false)
	if err != nil {
	...
	_, totalPath, err := repo.ListTasksByWorkspace(ctx, "ws-1", "myproject", 1, 10, false, false, false)
	if err != nil {
	...
	tasksNone, totalNone, err := repo.ListTasksByWorkspace(ctx, "ws-1", "nonexistent", 1, 10, false, false, false)
	if err != nil {
