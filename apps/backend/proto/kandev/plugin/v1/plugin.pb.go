...
const file_kandev_plugin_v1_plugin_proto_rawDesc = "" +
	...
	"\x0fInvokeAgentTool\x12\".kandev.plugin.v1.AgentToolRequest\x1a#.kandev.plugin.v1.AgentToolResponse2\x90\x1a\n" +
	"\x04Host\x12Q\n" +
...
var file_kandev_plugin_v1_plugin_proto_msgTypes = make([]protoimpl.MessageInfo, 116)
var file_kandev_plugin_v1_plugin_proto_goTypes = []any{
	...
	(*Workspace)(nil),                          // 53: kandev.plugin.v1.Workspace
	(*ListWorkspacesRequest)(nil),              // 54: kandev.plugin.v1.ListWorkspacesRequest
	(*ListWorkspacesResponse)(nil),             // 55: kandev.plugin.v1.ListWorkspacesResponse
	(*Workflow)(nil),                           // 56: kandev.plugin.v1.Workflow
	(*ListWorkflowsRequest)(nil),               // 57: kandev.plugin.v1.ListWorkflowsRequest
	(*ListWorkflowsResponse)(nil),              // 58: kandev.plugin.v1.ListWorkflowsResponse
	(*WorkflowStep)(nil),                       // 59: kandev.plugin.v1.WorkflowStep
	(*ListWorkflowStepsRequest)(nil),           // 60: kandev.plugin.v1.ListWorkflowStepsRequest
	(*ListWorkflowStepsResponse)(nil),          // 61: kandev.plugin.v1.ListWorkflowStepsResponse
	(*AgentProfile)(nil),                       // 62: kandev.plugin.v1.AgentProfile
	(*ListAgentProfilesRequest)(nil),           // 63: kandev.plugin.v1.ListAgentProfilesRequest
	(*ListAgentProfilesResponse)(nil),          // 64: kandev.plugin.v1.ListAgentProfilesResponse
	(*ExecutorProfile)(nil),                    // 65: kandev.plugin.v1.ExecutorProfile
	(*ListExecutorProfilesRequest)(nil),        // 66: kandev.plugin.v1.ListExecutorProfilesRequest
	(*ListExecutorProfilesResponse)(nil),       // 67: kandev.plugin.v1.ListExecutorProfilesResponse
	(*Repository)(nil),                         // 68: kandev.plugin.v1.Repository
	(*ListRepositoriesRequest)(nil),            // 69: kandev.plugin.v1.ListRepositoriesRequest
	(*ListRepositoriesResponse)(nil),           // 70: kandev.plugin.v1.ListRepositoriesResponse
	(*Session)(nil),                            // 71: kandev.plugin.v1.Session
	(*SessionFilter)(nil),                      // 72: kandev.plugin.v1.SessionFilter
	(*ListSessionsRequest)(nil),                // 73: kandev.plugin.v1.ListSessionsRequest
	(*ListSessionsResponse)(nil),               // 74: kandev.plugin.v1.ListSessionsResponse
	(*SessionCodeStats)(nil),                   // 75: kandev.plugin.v1.SessionCodeStats
	(*ListSessionCodeStatsRequest)(nil),        // 76: kandev.plugin.v1.ListSessionCodeStatsRequest
	(*ListSessionCodeStatsResponse)(nil),       // 77: kandev.plugin.v1.ListSessionCodeStatsResponse
	(*Message)(nil),                            // 78: kandev.plugin.v1.Message
	(*MessageFilter)(nil),                      // 79: kandev.plugin.v1.MessageFilter
	(*ListMessagesRequest)(nil),                // 80: kandev.plugin.v1.ListMessagesRequest
	(*ListMessagesResponse)(nil),               // 81: kandev.plugin.v1.ListMessagesResponse
	(*InteractionOption)(nil),                  // 82: kandev.plugin.v1.InteractionOption
	(*InteractionQuestion)(nil),                // 83: kandev.plugin.v1.InteractionQuestion
	(*Interaction)(nil),                        // 84: kandev.plugin.v1.Interaction
	(*InteractionFilter)(nil),                  // 85: kandev.plugin.v1.InteractionFilter
	(*ListPendingInteractionsRequest)(nil),     // 86: kandev.plugin.v1.ListPendingInteractionsRequest
	(*ListPendingInteractionsResponse)(nil),    // 87: kandev.plugin.v1.ListPendingInteractionsResponse
	(*GetInteractionRequest)(nil),              // 88: kandev.plugin.v1.GetInteractionRequest
	(*GetInteractionResponse)(nil),             // 89: kandev.plugin.v1.GetInteractionResponse
	(*RespondToPermissionRequest)(nil),         // 90: kandev.plugin.v1.RespondToPermissionRequest
	(*RespondToPermissionResponse)(nil),        // 91: kandev.plugin.v1.RespondToPermissionResponse
	(*ClarificationAnswer)(nil),                // 92: kandev.plugin.v1.ClarificationAnswer
	(*AnswerClarificationRequest)(nil),         // 93: kandev.plugin.v1.AnswerClarificationRequest
	(*AnswerClarificationResponse)(nil),        // 94: kandev.plugin.v1.AnswerClarificationResponse
	(*CancelClarificationRequest)(nil),         // 95: kandev.plugin.v1.CancelClarificationRequest
	(*CancelClarificationResponse)(nil),        // 96: kandev.plugin.v1.CancelClarificationResponse
	(*InvokeUtilityAgentRequest)(nil),          // 97: kandev.plugin.v1.InvokeUtilityAgentRequest
	(*InvokeUtilityAgentResponse)(nil),         // 98: kandev.plugin.v1.InvokeUtilityAgentResponse
	(*CreateTaskRequest)(nil),                  // 99: kandev.plugin.v1.CreateTaskRequest
	(*PluginTaskRepository)(nil),               // 100: kandev.plugin.v1.PluginTaskRepository
	(*RemoteRepositoryDescriptor)(nil),         // 101: kandev.plugin.v1.RemoteRepositoryDescriptor
	(*PluginTaskLaunchOptions)(nil),            // 102: kandev.plugin.v1.PluginTaskLaunchOptions
	(*CreateTaskResponse)(nil),                 // 103: kandev.plugin.v1.CreateTaskResponse
	(*UpdateTaskRequest)(nil),                  // 104: kandev.plugin.v1.UpdateTaskRequest
	(*UpdateTaskResponse)(nil),                 // 105: kandev.plugin.v1.UpdateTaskResponse
	...
	nil,                     // 113: kandev.plugin.v1.WebhookRequest.HeadersEntry
	nil,                     // 114: kandev.plugin.v1.WebhookResponse.HeadersEntry
	nil,                     // 115: kandev.plugin.v1.PluginActionResponse.HeadersEntry
	(*structpb.Struct)(nil), // 116: google.protobuf.Struct
}
var file_kandev_plugin_v1_plugin_proto_depIdxs = []int32{
	116, // 0: kandev.plugin.v1.Event.payload:type_name -> google.protobuf.Struct
	116, // 1: kandev.plugin.v1.AgentToolRequest.arguments:type_name -> google.protobuf.Struct
	3,   // 2: kandev.plugin.v1.AgentToolRequest.context:type_name -> kandev.plugin.v1.AgentToolContext
	116, // 3: kandev.plugin.v1.AgentToolResponse.structured_content:type_name -> google.protobuf.Struct
	113, // 4: kandev.plugin.v1.WebhookRequest.headers:type_name -> kandev.plugin.v1.WebhookRequest.HeadersEntry
	114, // 5: kandev.plugin.v1.WebhookResponse.headers:type_name -> kandev.plugin.v1.WebhookResponse.HeadersEntry
	8,   // 6: kandev.plugin.v1.PluginActionRequest.context:type_name -> kandev.plugin.v1.VerifiedActionContext
	115, // 7: kandev.plugin.v1.PluginActionResponse.headers:type_name -> kandev.plugin.v1.PluginActionResponse.HeadersEntry
	12,  // 8: kandev.plugin.v1.SearchEntityReferencesResponse.candidates:type_name -> kandev.plugin.v1.EntityReferenceCandidate
	116, // 9: kandev.plugin.v1.EntityReferenceCandidate.attributes:type_name -> google.protobuf.Struct
	116, // 10: kandev.plugin.v1.AuthorizeEntityReferenceRequest.reference:type_name -> google.protobuf.Struct
	116, // 11: kandev.plugin.v1.GetStateResponse.value:type_name -> google.protobuf.Struct
	116, // 12: kandev.plugin.v1.SetStateRequest.value:type_name -> google.protobuf.Struct
	27,  // 13: kandev.plugin.v1.ListStateResponse.entries:type_name -> kandev.plugin.v1.StateEntry
	116, // 14: kandev.plugin.v1.StateEntry.value:type_name -> google.protobuf.Struct
	116, // 15: kandev.plugin.v1.GetConfigResponse.config:type_name -> google.protobuf.Struct
	116, // 16: kandev.plugin.v1.EmitEventRequest.payload:type_name -> google.protobuf.Struct
	43,  // 17: kandev.plugin.v1.Task.repositories:type_name -> kandev.plugin.v1.TaskRepository
	116, // 18: kandev.plugin.v1.Task.metadata:type_name -> google.protobuf.Struct
	...
	40,  // 31: kandev.plugin.v1.ListWorkspacesRequest.page:type_name -> kandev.plugin.v1.Page
	53,  // 32: kandev.plugin.v1.ListWorkspacesResponse.workspaces:type_name -> kandev.plugin.v1.Workspace
	41,  // 33: kandev.plugin.v1.ListWorkspacesResponse.page_info:type_name -> kandev.plugin.v1.PageInfo
	40,  // 34: kandev.plugin.v1.ListWorkflowsRequest.page:type_name -> kandev.plugin.v1.Page
	56,  // 35: kandev.plugin.v1.ListWorkflowsResponse.workflows:type_name -> kandev.plugin.v1.Workflow
	41,  // 36: kandev.plugin.v1.ListWorkflowsResponse.page_info:type_name -> kandev.plugin.v1.PageInfo
	59,  // 37: kandev.plugin.v1.ListWorkflowStepsResponse.steps:type_name -> kandev.plugin.v1.WorkflowStep
	40,  // 38: kandev.plugin.v1.ListAgentProfilesRequest.page:type_name -> kandev.plugin.v1.Page
	62,  // 39: kandev.plugin.v1.ListAgentProfilesResponse.profiles:type_name -> kandev.plugin.v1.AgentProfile
	41,  // 40: kandev.plugin.v1.ListAgentProfilesResponse.page_info:type_name -> kandev.plugin.v1.PageInfo
	40,  // 41: kandev.plugin.v1.ListExecutorProfilesRequest.page:type_name -> kandev.plugin.v1.Page
	65,  // 42: kandev.plugin.v1.ListExecutorProfilesResponse.profiles:type_name -> kandev.plugin.v1.ExecutorProfile
	41,  // 43: kandev.plugin.v1.ListExecutorProfilesResponse.page_info:type_name -> kandev.plugin.v1.PageInfo
	40,  // 44: kandev.plugin.v1.ListRepositoriesRequest.page:type_name -> kandev.plugin.v1.Page
	68,  // 45: kandev.plugin.v1.ListRepositoriesResponse.repositories:type_name -> kandev.plugin.v1.Repository
	41,  // 46: kandev.plugin.v1.ListRepositoriesResponse.page_info:type_name -> kandev.plugin.v1.PageInfo
	72,  // 47: kandev.plugin.v1.ListSessionsRequest.filter:type_name -> kandev.plugin.v1.SessionFilter
	40,  // 48: kandev.plugin.v1.ListSessionsRequest.page:type_name -> kandev.plugin.v1.Page
	71,  // 49: kandev.plugin.v1.ListSessionsResponse.sessions:type_name -> kandev.plugin.v1.Session
	41,  // 50: kandev.plugin.v1.ListSessionsResponse.page_info:type_name -> kandev.plugin.v1.PageInfo
	72,  // 51: kandev.plugin.v1.ListSessionCodeStatsRequest.filter:type_name -> kandev.plugin.v1.SessionFilter
	40,  // 52: kandev.plugin.v1.ListSessionCodeStatsRequest.page:type_name -> kandev.plugin.v1.Page
	75,  // 53: kandev.plugin.v1.ListSessionCodeStatsResponse.stats:type_name -> kandev.plugin.v1.SessionCodeStats
	41,  // 54: kandev.plugin.v1.ListSessionCodeStatsResponse.page_info:type_name -> kandev.plugin.v1.PageInfo
	79,  // 55: kandev.plugin.v1.ListMessagesRequest.filter:type_name -> kandev.plugin.v1.MessageFilter
	40,  // 56: kandev.plugin.v1.ListMessagesRequest.page:type_name -> kandev.plugin.v1.Page
	78,  // 57: kandev.plugin.v1.ListMessagesResponse.messages:type_name -> kandev.plugin.v1.Message
	41,  // 58: kandev.plugin.v1.ListMessagesResponse.page_info:type_name -> kandev.plugin.v1.PageInfo
	82,  // 59: kandev.plugin.v1.InteractionQuestion.options:type_name -> kandev.plugin.v1.InteractionOption
	82,  // 60: kandev.plugin.v1.Interaction.options:type_name -> kandev.plugin.v1.InteractionOption
	83,  // 61: kandev.plugin.v1.Interaction.questions:type_name -> kandev.plugin.v1.InteractionQuestion
	85,  // 62: kandev.plugin.v1.ListPendingInteractionsRequest.filter:type_name -> kandev.plugin.v1.InteractionFilter
	40,  // 63: kandev.plugin.v1.ListPendingInteractionsRequest.page:type_name -> kandev.plugin.v1.Page
	84,  // 64: kandev.plugin.v1.ListPendingInteractionsResponse.interactions:type_name -> kandev.plugin.v1.Interaction
	41,  // 65: kandev.plugin.v1.ListPendingInteractionsResponse.page_info:type_name -> kandev.plugin.v1.PageInfo
	84,  // 66: kandev.plugin.v1.GetInteractionResponse.interaction:type_name -> kandev.plugin.v1.Interaction
	84,  // 67: kandev.plugin.v1.RespondToPermissionResponse.interaction:type_name -> kandev.plugin.v1.Interaction
	92,  // 68: kandev.plugin.v1.AnswerClarificationRequest.answers:type_name -> kandev.plugin.v1.ClarificationAnswer
	84,  // 69: kandev.plugin.v1.AnswerClarificationResponse.interaction:type_name -> kandev.plugin.v1.Interaction
	84,  // 70: kandev.plugin.v1.CancelClarificationResponse.interaction:type_name -> kandev.plugin.v1.Interaction
	100, // 71: kandev.plugin.v1.CreateTaskRequest.repositories:type_name -> kandev.plugin.v1.PluginTaskRepository
	102, // 72: kandev.plugin.v1.CreateTaskRequest.launch:type_name -> kandev.plugin.v1.PluginTaskLaunchOptions
	116, // 73: kandev.plugin.v1.CreateTaskRequest.metadata:type_name -> google.protobuf.Struct
	101, // 74: kandev.plugin.v1.PluginTaskRepository.remote:type_name -> kandev.plugin.v1.RemoteRepositoryDescriptor
	42,  // 75: kandev.plugin.v1.CreateTaskResponse.task:type_name -> kandev.plugin.v1.Task
	42,  // 76: kandev.plugin.v1.UpdateTaskResponse.task:type_name -> kandev.plugin.v1.Task
	42,  // 77: kandev.plugin.v1.PreviewPluginOwnedTaskTreeResponse.tasks:type_name -> kandev.plugin.v1.Task
	0,   // 78: kandev.plugin.v1.Plugin.DeliverEvent:input_type -> kandev.plugin.v1.Event
	5,   // 79: kandev.plugin.v1.Plugin.HandleWebhook:input_type -> kandev.plugin.v1.WebhookRequest
	7,   // 80: kandev.plugin.v1.Plugin.HandleAction:input_type -> kandev.plugin.v1.PluginActionRequest
	10,  // 81: kandev.plugin.v1.Plugin.SearchEntityReferences:input_type -> kandev.plugin.v1.SearchEntityReferencesRequest
	13,  // 82: kandev.plugin.v1.Plugin.AuthorizeEntityReference:input_type -> kandev.plugin.v1.AuthorizeEntityReferenceRequest
	15,  // 83: kandev.plugin.v1.Plugin.ResolveGitCredential:input_type -> kandev.plugin.v1.ResolveGitCredentialRequest
	17,  // 84: kandev.plugin.v1.Plugin.GetGitCredentialBinding:input_type -> kandev.plugin.v1.GitCredentialBindingRequest
	2,   // 85: kandev.plugin.v1.Plugin.InvokeAgentTool:input_type -> kandev.plugin.v1.AgentToolRequest
	19,  // 86: kandev.plugin.v1.Host.GetState:input_type -> kandev.plugin.v1.GetStateRequest
	21,  // 87: kandev.plugin.v1.Host.SetState:input_type -> kandev.plugin.v1.SetStateRequest
	23,  // 88: kandev.plugin.v1.Host.DeleteState:input_type -> kandev.plugin.v1.DeleteStateRequest
	25,  // 89: kandev.plugin.v1.Host.ListState:input_type -> kandev.plugin.v1.ListStateRequest
	36,  // 90: kandev.plugin.v1.Host.RevealSecret:input_type -> kandev.plugin.v1.RevealSecretRequest
	38,  // 91: kandev.plugin.v1.Host.EmitEvent:input_type -> kandev.plugin.v1.EmitEventRequest
	30,  // 92: kandev.plugin.v1.Host.GetSecret:input_type -> kandev.plugin.v1.GetSecretRequest
	32,  // 93: kandev.plugin.v1.Host.SetSecret:input_type -> kandev.plugin.v1.SetSecretRequest
	34,  // 94: kandev.plugin.v1.Host.DeleteSecret:input_type -> kandev.plugin.v1.DeleteSecretRequest
	28,  // 95: kandev.plugin.v1.Host.GetConfig:input_type -> kandev.plugin.v1.GetConfigRequest
	45,  // 96: kandev.plugin.v1.Host.ListTasks:input_type -> kandev.plugin.v1.ListTasksRequest
	47,  // 97: kandev.plugin.v1.Host.GetTask:input_type -> kandev.plugin.v1.GetTaskRequest
	51,  // 98: kandev.plugin.v1.Host.GetTaskRelations:input_type -> kandev.plugin.v1.GetTaskRelationsRequest
	54,  // 99: kandev.plugin.v1.Host.ListWorkspaces:input_type -> kandev.plugin.v1.ListWorkspacesRequest
	57,  // 100: kandev.plugin.v1.Host.ListWorkflows:input_type -> kandev.plugin.v1.ListWorkflowsRequest
	60,  // 101: kandev.plugin.v1.Host.ListWorkflowSteps:input_type -> kandev.plugin.v1.ListWorkflowStepsRequest
	63,  // 102: kandev.plugin.v1.Host.ListAgentProfiles:input_type -> kandev.plugin.v1.ListAgentProfilesRequest
	66,  // 103: kandev.plugin.v1.Host.ListExecutorProfiles:input_type -> kandev.plugin.v1.ListExecutorProfilesRequest
	69,  // 104: kandev.plugin.v1.Host.ListRepositories:input_type -> kandev.plugin.v1.ListRepositoriesRequest
	73,  // 105: kandev.plugin.v1.Host.ListSessions:input_type -> kandev.plugin.v1.ListSessionsRequest
	76,  // 106: kandev.plugin.v1.Host.ListSessionCodeStats:input_type -> kandev.plugin.v1.ListSessionCodeStatsRequest
	80,  // 107: kandev.plugin.v1.Host.ListMessages:input_type -> kandev.plugin.v1.ListMessagesRequest
	86,  // 108: kandev.plugin.v1.Host.ListPendingInteractions:input_type -> kandev.plugin.v1.ListPendingInteractionsRequest
	88,  // 109: kandev.plugin.v1.Host.GetInteraction:input_type -> kandev.plugin.v1.GetInteractionRequest
	97,  // 110: kandev.plugin.v1.Host.InvokeUtilityAgent:input_type -> kandev.plugin.v1.InvokeUtilityAgentRequest
	99,  // 111: kandev.plugin.v1.Host.CreateTask:input_type -> kandev.plugin.v1.CreateTaskRequest
	104, // 112: kandev.plugin.v1.Host.UpdateTask:input_type -> kandev.plugin.v1.UpdateTaskRequest
	106, // 113: kandev.plugin.v1.Host.SendMessage:input_type -> kandev.plugin.v1.SendMessageRequest
	108, // 114: kandev.plugin.v1.Host.PreviewPluginOwnedTaskTree:input_type -> kandev.plugin.v1.PreviewPluginOwnedTaskTreeRequest
	110, // 115: kandev.plugin.v1.Host.DeletePluginOwnedTaskTree:input_type -> kandev.plugin.v1.DeletePluginOwnedTaskTreeRequest
	90,  // 116: kandev.plugin.v1.Host.RespondToPermission:input_type -> kandev.plugin.v1.RespondToPermissionRequest
	93,  // 117: kandev.plugin.v1.Host.AnswerClarification:input_type -> kandev.plugin.v1.AnswerClarificationRequest
	95,  // 118: kandev.plugin.v1.Host.CancelClarification:input_type -> kandev.plugin.v1.CancelClarificationRequest
	1,   // 119: kandev.plugin.v1.Plugin.DeliverEvent:output_type -> kandev.plugin.v1.EventAck
	6,   // 120: kandev.plugin.v1.Plugin.HandleWebhook:output_type -> kandev.plugin.v1.WebhookResponse
	...
	46,  // 137: kandev.plugin.v1.Host.ListTasks:output_type -> kandev.plugin.v1.ListTasksResponse
	48,  // 138: kandev.plugin.v1.Host.GetTask:output_type -> kandev.plugin.v1.GetTaskResponse
	52,  // 139: kandev.plugin.v1.Host.GetTaskRelations:output_type -> kandev.plugin.v1.GetTaskRelationsResponse
	55,  // 140: kandev.plugin.v1.Host.ListWorkspaces:output_type -> kandev.plugin.v1.ListWorkspacesResponse
	58,  // 141: kandev.plugin.v1.Host.ListWorkflows:output_type -> kandev.plugin.v1.ListWorkflowsResponse
	61,  // 142: kandev.plugin.v1.Host.ListWorkflowSteps:output_type -> kandev.plugin.v1.ListWorkflowStepsResponse
	64,  // 143: kandev.plugin.v1.Host.ListAgentProfiles:output_type -> kandev.plugin.v1.ListAgentProfilesResponse
	67,  // 144: kandev.plugin.v1.Host.ListExecutorProfiles:output_type -> kandev.plugin.v1.ListExecutorProfilesResponse
	70,  // 145: kandev.plugin.v1.Host.ListRepositories:output_type -> kandev.plugin.v1.ListRepositoriesResponse
	74,  // 146: kandev.plugin.v1.Host.ListSessions:output_type -> kandev.plugin.v1.ListSessionsResponse
	77,  // 147: kandev.plugin.v1.Host.ListSessionCodeStats:output_type -> kandev.plugin.v1.ListSessionCodeStatsResponse
	81,  // 148: kandev.plugin.v1.Host.ListMessages:output_type -> kandev.plugin.v1.ListMessagesResponse
	87,  // 149: kandev.plugin.v1.Host.ListPendingInteractions:output_type -> kandev.plugin.v1.ListPendingInteractionsResponse
	89,  // 150: kandev.plugin.v1.Host.GetInteraction:output_type -> kandev.plugin.v1.GetInteractionResponse
	98,  // 151: kandev.plugin.v1.Host.InvokeUtilityAgent:output_type -> kandev.plugin.v1.InvokeUtilityAgentResponse
	103, // 152: kandev.plugin.v1.Host.CreateTask:output_type -> kandev.plugin.v1.CreateTaskResponse
	105, // 153: kandev.plugin.v1.Host.UpdateTask:output_type -> kandev.plugin.v1.UpdateTaskResponse
	107, // 154: kandev.plugin.v1.Host.SendMessage:output_type -> kandev.plugin.v1.SendMessageResponse
	109, // 155: kandev.plugin.v1.Host.PreviewPluginOwnedTaskTree:output_type -> kandev.plugin.v1.PreviewPluginOwnedTaskTreeResponse
	111, // 156: kandev.plugin.v1.Host.DeletePluginOwnedTaskTree:output_type -> kandev.plugin.v1.DeletePluginOwnedTaskTreeResponse
	91,  // 157: kandev.plugin.v1.Host.RespondToPermission:output_type -> kandev.plugin.v1.RespondToPermissionResponse
	94,  // 158: kandev.plugin.v1.Host.AnswerClarification:output_type -> kandev.plugin.v1.AnswerClarificationResponse
	96,  // 159: kandev.plugin.v1.Host.CancelClarification:output_type -> kandev.plugin.v1.CancelClarificationResponse
