...
const file_kandev_plugin_v1_plugin_proto_rawDesc = "" +
	...
	"\rHandleWebhook\x12 .kandev.plugin.v1.WebhookRequest\x1a!.kandev.plugin.v1.WebhookResponse2\x87\x0e\n" +
	"\x04Host\x12Q\n" +
...
var file_kandev_plugin_v1_plugin_proto_msgTypes = make([]protoimpl.MessageInfo, 62)
var file_kandev_plugin_v1_plugin_proto_goTypes = []any{
	...
	(*RevealSecretRequest)(nil),          // 18: kandev.plugin.v1.RevealSecretRequest
	(*RevealSecretResponse)(nil),         // 19: kandev.plugin.v1.RevealSecretResponse
	(*EmitEventRequest)(nil),             // 20: kandev.plugin.v1.EmitEventRequest
	(*EmitEventResponse)(nil),            // 21: kandev.plugin.v1.EmitEventResponse
	(*Page)(nil),                         // 22: kandev.plugin.v1.Page
	(*PageInfo)(nil),                     // 23: kandev.plugin.v1.PageInfo
	(*Task)(nil),                         // 24: kandev.plugin.v1.Task
	(*TaskRepository)(nil),               // 25: kandev.plugin.v1.TaskRepository
	(*TaskFilter)(nil),                   // 26: kandev.plugin.v1.TaskFilter
	(*ListTasksRequest)(nil),             // 27: kandev.plugin.v1.ListTasksRequest
	(*ListTasksResponse)(nil),            // 28: kandev.plugin.v1.ListTasksResponse
	(*GetTaskRequest)(nil),               // 29: kandev.plugin.v1.GetTaskRequest
	(*GetTaskResponse)(nil),              // 30: kandev.plugin.v1.GetTaskResponse
	(*Workspace)(nil),                    // 31: kandev.plugin.v1.Workspace
	(*ListWorkspacesRequest)(nil),        // 32: kandev.plugin.v1.ListWorkspacesRequest
	(*ListWorkspacesResponse)(nil),       // 33: kandev.plugin.v1.ListWorkspacesResponse
	(*Workflow)(nil),                     // 34: kandev.plugin.v1.Workflow
	(*ListWorkflowsRequest)(nil),         // 35: kandev.plugin.v1.ListWorkflowsRequest
	(*ListWorkflowsResponse)(nil),        // 36: kandev.plugin.v1.ListWorkflowsResponse
	(*WorkflowStep)(nil),                 // 37: kandev.plugin.v1.WorkflowStep
	(*ListWorkflowStepsRequest)(nil),     // 38: kandev.plugin.v1.ListWorkflowStepsRequest
	(*ListWorkflowStepsResponse)(nil),    // 39: kandev.plugin.v1.ListWorkflowStepsResponse
	(*AgentProfile)(nil),                 // 40: kandev.plugin.v1.AgentProfile
	(*ListAgentProfilesRequest)(nil),     // 41: kandev.plugin.v1.ListAgentProfilesRequest
	(*ListAgentProfilesResponse)(nil),    // 42: kandev.plugin.v1.ListAgentProfilesResponse
	(*Repository)(nil),                   // 43: kandev.plugin.v1.Repository
	(*ListRepositoriesRequest)(nil),      // 44: kandev.plugin.v1.ListRepositoriesRequest
	(*ListRepositoriesResponse)(nil),     // 45: kandev.plugin.v1.ListRepositoriesResponse
	(*Session)(nil),                      // 46: kandev.plugin.v1.Session
	(*SessionFilter)(nil),                // 47: kandev.plugin.v1.SessionFilter
	(*ListSessionsRequest)(nil),          // 48: kandev.plugin.v1.ListSessionsRequest
	(*ListSessionsResponse)(nil),         // 49: kandev.plugin.v1.ListSessionsResponse
	(*SessionCodeStats)(nil),             // 50: kandev.plugin.v1.SessionCodeStats
	(*ListSessionCodeStatsRequest)(nil),  // 51: kandev.plugin.v1.ListSessionCodeStatsRequest
	(*ListSessionCodeStatsResponse)(nil), // 52: kandev.plugin.v1.ListSessionCodeStatsResponse
	(*CreateTaskRequest)(nil),            // 53: kandev.plugin.v1.CreateTaskRequest
	(*CreateTaskResponse)(nil),           // 54: kandev.plugin.v1.CreateTaskResponse
	(*UpdateTaskRequest)(nil),            // 55: kandev.plugin.v1.UpdateTaskRequest
	(*UpdateTaskResponse)(nil),           // 56: kandev.plugin.v1.UpdateTaskResponse
	(*Comment)(nil),                      // 57: kandev.plugin.v1.Comment
	(*CreateCommentRequest)(nil),         // 58: kandev.plugin.v1.CreateCommentRequest
	(*CreateCommentResponse)(nil),        // 59: kandev.plugin.v1.CreateCommentResponse
	nil,                                  // 60: kandev.plugin.v1.WebhookRequest.HeadersEntry
	nil,                                  // 61: kandev.plugin.v1.WebhookResponse.HeadersEntry
	(*structpb.Struct)(nil),              // 62: google.protobuf.Struct
}
var file_kandev_plugin_v1_plugin_proto_depIdxs = []int32{
	62, // 0: kandev.plugin.v1.Event.payload:type_name -> google.protobuf.Struct
	62, // 1: kandev.plugin.v1.ToolRequest.input:type_name -> google.protobuf.Struct
	3,  // 2: kandev.plugin.v1.ToolRequest.context:type_name -> kandev.plugin.v1.ToolContext
	62, // 3: kandev.plugin.v1.ToolResponse.output:type_name -> google.protobuf.Struct
	60, // 4: kandev.plugin.v1.WebhookRequest.headers:type_name -> kandev.plugin.v1.WebhookRequest.HeadersEntry
	61, // 5: kandev.plugin.v1.WebhookResponse.headers:type_name -> kandev.plugin.v1.WebhookResponse.HeadersEntry
	62, // 6: kandev.plugin.v1.GetStateResponse.value:type_name -> google.protobuf.Struct
	62, // 7: kandev.plugin.v1.SetStateRequest.value:type_name -> google.protobuf.Struct
	15, // 8: kandev.plugin.v1.ListStateResponse.entries:type_name -> kandev.plugin.v1.StateEntry
	62, // 9: kandev.plugin.v1.StateEntry.value:type_name -> google.protobuf.Struct
	62, // 10: kandev.plugin.v1.GetConfigResponse.config:type_name -> google.protobuf.Struct
	62, // 11: kandev.plugin.v1.EmitEventRequest.payload:type_name -> google.protobuf.Struct
	25, // 12: kandev.plugin.v1.Task.repositories:type_name -> kandev.plugin.v1.TaskRepository
	62, // 13: kandev.plugin.v1.Task.metadata:type_name -> google.protobuf.Struct
	26, // 14: kandev.plugin.v1.ListTasksRequest.filter:type_name -> kandev.plugin.v1.TaskFilter
	22, // 15: kandev.plugin.v1.ListTasksRequest.page:type_name -> kandev.plugin.v1.Page
	24, // 16: kandev.plugin.v1.ListTasksResponse.tasks:type_name -> kandev.plugin.v1.Task
	23, // 17: kandev.plugin.v1.ListTasksResponse.page_info:type_name -> kandev.plugin.v1.PageInfo
	24, // 18: kandev.plugin.v1.GetTaskResponse.task:type_name -> kandev.plugin.v1.Task
	22, // 19: kandev.plugin.v1.ListWorkspacesRequest.page:type_name -> kandev.plugin.v1.Page
	31, // 20: kandev.plugin.v1.ListWorkspacesResponse.workspaces:type_name -> kandev.plugin.v1.Workspace
	23, // 21: kandev.plugin.v1.ListWorkspacesResponse.page_info:type_name -> kandev.plugin.v1.PageInfo
	22, // 22: kandev.plugin.v1.ListWorkflowsRequest.page:type_name -> kandev.plugin.v1.Page
	34, // 23: kandev.plugin.v1.ListWorkflowsResponse.workflows:type_name -> kandev.plugin.v1.Workflow
	23, // 24: kandev.plugin.v1.ListWorkflowsResponse.page_info:type_name -> kandev.plugin.v1.PageInfo
	37, // 25: kandev.plugin.v1.ListWorkflowStepsResponse.steps:type_name -> kandev.plugin.v1.WorkflowStep
	22, // 26: kandev.plugin.v1.ListAgentProfilesRequest.page:type_name -> kandev.plugin.v1.Page
	40, // 27: kandev.plugin.v1.ListAgentProfilesResponse.profiles:type_name -> kandev.plugin.v1.AgentProfile
	23, // 28: kandev.plugin.v1.ListAgentProfilesResponse.page_info:type_name -> kandev.plugin.v1.PageInfo
	22, // 29: kandev.plugin.v1.ListRepositoriesRequest.page:type_name -> kandev.plugin.v1.Page
	43, // 30: kandev.plugin.v1.ListRepositoriesResponse.repositories:type_name -> kandev.plugin.v1.Repository
	23, // 31: kandev.plugin.v1.ListRepositoriesResponse.page_info:type_name -> kandev.plugin.v1.PageInfo
	47, // 32: kandev.plugin.v1.ListSessionsRequest.filter:type_name -> kandev.plugin.v1.SessionFilter
	22, // 33: kandev.plugin.v1.ListSessionsRequest.page:type_name -> kandev.plugin.v1.Page
	46, // 34: kandev.plugin.v1.ListSessionsResponse.sessions:type_name -> kandev.plugin.v1.Session
	23, // 35: kandev.plugin.v1.ListSessionsResponse.page_info:type_name -> kandev.plugin.v1.PageInfo
	47, // 36: kandev.plugin.v1.ListSessionCodeStatsRequest.filter:type_name -> kandev.plugin.v1.SessionFilter
	22, // 37: kandev.plugin.v1.ListSessionCodeStatsRequest.page:type_name -> kandev.plugin.v1.Page
	50, // 38: kandev.plugin.v1.ListSessionCodeStatsResponse.stats:type_name -> kandev.plugin.v1.SessionCodeStats
	23, // 39: kandev.plugin.v1.ListSessionCodeStatsResponse.page_info:type_name -> kandev.plugin.v1.PageInfo
	24, // 40: kandev.plugin.v1.CreateTaskResponse.task:type_name -> kandev.plugin.v1.Task
	24, // 41: kandev.plugin.v1.UpdateTaskResponse.task:type_name -> kandev.plugin.v1.Task
	57, // 42: kandev.plugin.v1.CreateCommentResponse.comment:type_name -> kandev.plugin.v1.Comment
	...
	18, // 50: kandev.plugin.v1.Host.RevealSecret:input_type -> kandev.plugin.v1.RevealSecretRequest
	20, // 51: kandev.plugin.v1.Host.EmitEvent:input_type -> kandev.plugin.v1.EmitEventRequest
	16, // 52: kandev.plugin.v1.Host.GetConfig:input_type -> kandev.plugin.v1.GetConfigRequest
	27, // 53: kandev.plugin.v1.Host.ListTasks:input_type -> kandev.plugin.v1.ListTasksRequest
	29, // 54: kandev.plugin.v1.Host.GetTask:input_type -> kandev.plugin.v1.GetTaskRequest
	32, // 55: kandev.plugin.v1.Host.ListWorkspaces:input_type -> kandev.plugin.v1.ListWorkspacesRequest
	35, // 56: kandev.plugin.v1.Host.ListWorkflows:input_type -> kandev.plugin.v1.ListWorkflowsRequest
	38, // 57: kandev.plugin.v1.Host.ListWorkflowSteps:input_type -> kandev.plugin.v1.ListWorkflowStepsRequest
	41, // 58: kandev.plugin.v1.Host.ListAgentProfiles:input_type -> kandev.plugin.v1.ListAgentProfilesRequest
	44, // 59: kandev.plugin.v1.Host.ListRepositories:input_type -> kandev.plugin.v1.ListRepositoriesRequest
	48, // 60: kandev.plugin.v1.Host.ListSessions:input_type -> kandev.plugin.v1.ListSessionsRequest
	51, // 61: kandev.plugin.v1.Host.ListSessionCodeStats:input_type -> kandev.plugin.v1.ListSessionCodeStatsRequest
	53, // 62: kandev.plugin.v1.Host.CreateTask:input_type -> kandev.plugin.v1.CreateTaskRequest
	55, // 63: kandev.plugin.v1.Host.UpdateTask:input_type -> kandev.plugin.v1.UpdateTaskRequest
	58, // 64: kandev.plugin.v1.Host.CreateComment:input_type -> kandev.plugin.v1.CreateCommentRequest
	1,  // 65: kandev.plugin.v1.Plugin.DeliverEvent:output_type -> kandev.plugin.v1.EventAck
	4,  // 66: kandev.plugin.v1.Plugin.InvokeTool:output_type -> kandev.plugin.v1.ToolResponse
	6,  // 67: kandev.plugin.v1.Plugin.HandleWebhook:output_type -> kandev.plugin.v1.WebhookResponse
	8,  // 68: kandev.plugin.v1.Host.GetState:output_type -> kandev.plugin.v1.GetStateResponse
	10, // 69: kandev.plugin.v1.Host.SetState:output_type -> kandev.plugin.v1.SetStateResponse
	12, // 70: kandev.plugin.v1.Host.DeleteState:output_type -> kandev.plugin.v1.DeleteStateResponse
	14, // 71: kandev.plugin.v1.Host.ListState:output_type -> kandev.plugin.v1.ListStateResponse
	19, // 72: kandev.plugin.v1.Host.RevealSecret:output_type -> kandev.plugin.v1.RevealSecretResponse
	21, // 73: kandev.plugin.v1.Host.EmitEvent:output_type -> kandev.plugin.v1.EmitEventResponse
	17, // 74: kandev.plugin.v1.Host.GetConfig:output_type -> kandev.plugin.v1.GetConfigResponse
	28, // 75: kandev.plugin.v1.Host.ListTasks:output_type -> kandev.plugin.v1.ListTasksResponse
	30, // 76: kandev.plugin.v1.Host.GetTask:output_type -> kandev.plugin.v1.GetTaskResponse
	33, // 77: kandev.plugin.v1.Host.ListWorkspaces:output_type -> kandev.plugin.v1.ListWorkspacesResponse
	36, // 78: kandev.plugin.v1.Host.ListWorkflows:output_type -> kandev.plugin.v1.ListWorkflowsResponse
	39, // 79: kandev.plugin.v1.Host.ListWorkflowSteps:output_type -> kandev.plugin.v1.ListWorkflowStepsResponse
	42, // 80: kandev.plugin.v1.Host.ListAgentProfiles:output_type -> kandev.plugin.v1.ListAgentProfilesResponse
	45, // 81: kandev.plugin.v1.Host.ListRepositories:output_type -> kandev.plugin.v1.ListRepositoriesResponse
	49, // 82: kandev.plugin.v1.Host.ListSessions:output_type -> kandev.plugin.v1.ListSessionsResponse
	52, // 83: kandev.plugin.v1.Host.ListSessionCodeStats:output_type -> kandev.plugin.v1.ListSessionCodeStatsResponse
	54, // 84: kandev.plugin.v1.Host.CreateTask:output_type -> kandev.plugin.v1.CreateTaskResponse
	56, // 85: kandev.plugin.v1.Host.UpdateTask:output_type -> kandev.plugin.v1.UpdateTaskResponse
	59, // 86: kandev.plugin.v1.Host.CreateComment:output_type -> kandev.plugin.v1.CreateCommentResponse
...
func file_kandev_plugin_v1_plugin_proto_init() {
	...
	file_kandev_plugin_v1_plugin_proto_msgTypes[26].OneofWrappers = []any{}
	...
	file_kandev_plugin_v1_plugin_proto_msgTypes[55].OneofWrappers = []any{}
	type x struct{}
