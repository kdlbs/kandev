...
| Git worktree  | Attempts to remove the Kandev-owned worktree directory. It keeps the local task branch and the remote branch. Shared or borrowed worktrees can remain until their last active user is gone. |
