...
- The display menu filters by **Workflow** and **Repository**, can enable **Open preview on click**, and in Kanban/Pipeline offers a **Steps** section to hide individual workflow steps — unticking a step hides its column and tasks on that board, scoped to its own workflow, until you re-tick it.
