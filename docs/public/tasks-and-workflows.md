...
1. Enter a concise title of up to 60 characters. Titles prefilled from a remote pull request or issue are shortened with an ellipsis when needed; the detailed context belongs in the description.
