...
| registerNavItem             | { id, label, path, icon?, section? }; section is main, integrations, insights (sidebar footer icon row and phone menu Utilities group), or accepted-but-not-rendered settings                                                                                                                                                                                             | Active ui.bundle                                                       | Nav item is revoked and removed from desktop/phone navigation                                                                                                                                                   | registry.registerNavItem({ id: "home", label: "Acme", path: "/acme", icon: "chart" })                               |
