...
visible; the last visible agent panel remains open. Closing panels survives a page reload in the
same browser tab: hidden conversations stay listed under **+ > Agents** until you reopen them.
