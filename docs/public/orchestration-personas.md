...
The [personal assistant backend reference](personal-assistant-api.md) documents the in-development objective, intake and shared-context additions, including retained private ownership across default changes and restrictions on private automation targets. This is not yet a complete central assistant UI or an enforced read-only execution mode.
