...
- For dense diagrams, use a tighter viewBox and larger readable type before publishing. Link the SVG image to itself so readers can open the full-size vector asset.
