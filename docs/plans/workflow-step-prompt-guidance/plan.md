...
| --- | --- |
| `AC-TASKS-WORKFLOW-STEP-AGENT-START-OWNERSHIP-007.1` through `.6` | Helper unit tests and desktop scenario in `apps/web/e2e/tests/workflow/workflow-settings.spec.ts` |
| `AC-TASKS-WORKFLOW-STEP-AGENT-START-OWNERSHIP-007.7` | Phone scenario in `apps/web/e2e/tests/workflow/mobile-workflow-settings.spec.ts` |
