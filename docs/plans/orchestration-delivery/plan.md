...
6. Finish assistant task 03, then 04, 05, 06, 07, 08, 09, 10, 11 in order. Task 06
   ...
   sequentially. Tasks 01–11 are complete, including inspected synthetic media.
...
Tasks 01–11 are complete and must not be redone. Task 11 retains its detailed
execution checklist, source boundaries, criterion references and verification.
Their authoritative
