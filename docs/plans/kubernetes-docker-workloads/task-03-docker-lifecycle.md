...
repository. Focused lifecycle regressions exercise both the built-in Kubernetes
script and the full worker script, preserve retained files, and reproduce the
restricted copy boundary with the real `cp` implementation.
