...
Focused implementation tests pass: 6 files, 51 tests. TypeScript typecheck
...
persistent selected-row styling. Mobile behavior keeps the existing command
and branch-sheet compositions, with 44px touch rows and no new overflow. The
changed frontend files pass targeted ESLint with zero warnings and Prettier.
