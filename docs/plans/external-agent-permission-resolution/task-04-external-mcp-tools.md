...
- Added handler/schema/surface/forwarding tests and an authenticated integration test covering
  ...
  replay rejection, and exactly one provider response. Task 01 and Task 03 tests cover projection
  redaction plus unknown option, stale/replaced, missing, concurrent, audit, and delivery failures
