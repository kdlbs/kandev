...
```bash
rg -n "10 MB|10 MiB|20 MB|20 MiB|32 MiB|100 MiB|attachment" docs/public/tasks-and-workflows.md docs/public/websocket-api.md docs/specs/office/live-updates.md docs/specs/tasks/prompt-attachments.md docs/decisions/2026-08-04-file-backed-prompt-attachments.md
...
- `docs/specs/tasks/prompt-attachments.md` only if implementation reveals a
