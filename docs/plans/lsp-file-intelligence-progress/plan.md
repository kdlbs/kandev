...
- **Completion and configuration:** focused provider and manager tests prove range fallback/override behavior, advertised trigger registration, all 25 standard completion-kind mappings, connection reuse, live configuration notification, and updated request responses.
