...
- **Task-host transport safety:** an agentctl integration test observes the bounded write deadline on the pre-bridge ready frame while the existing bridge tests retain process-cleanup coverage for failed and blocked writes.
