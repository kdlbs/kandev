...
- Public task and Git documentation explains the option gate, final-title rename, explicit remote
  checkout preservation, and best-effort failure behavior without implying that remote branches move.
...
- Public task-title guidance in `docs/public/tasks-and-workflows.md` and managed-branch guidance in
  `docs/public/git-operations.md`.
...
- Updated `docs/public/automation-and-mcp.md` and `docs/public/git-operations.md` with the option gate,
  final-title rename behavior, remote/PR preservation, Local preservation, and best-effort failure
  semantics.
