...
- **Agent CLIs:** Kandev supports ACP-native, ACP-adapter, and passthrough-only agents such as Claude Code, Codex, GitHub Copilot, Gemini CLI, Antigravity CLI, Amp, Auggie, OpenCode, Cursor, Qwen, Factory Droid, iFlow, Kilocode, Pi, Kimi, Kiro, Qoder, Trae, and Oh My Pi.
