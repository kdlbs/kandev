...
<table>
  <tr>
    ...
    <td align="center" valign="top" width="50%">
      ...
      <img src="screenshots/settings-executors.png" alt="Executors settings showing existing and available executor profiles" width="520">
    </td>
  </tr>
  <tr>
    <td colspan="2" align="center">
      ...
      <img src="screenshots/settings-agents.png" alt="Agents settings showing detected agent CLIs, profiles, and update indicators" width="760">
    </td>
  </tr>
</table>
...
<table>
  ...
  <tr>
    <td colspan="2" align="center">
      ...
      <img src="screenshots/automation-editor.png" alt="Automation editor showing repository access, run destination, context, and save controls" width="760">
    </td>
  </tr>
</table>
