...
| D7 | The plugin's interim path | The v1 fence stays as ADR-2026-08-31 defines it. The six open PRs that touch `internal/mcp` (#2756, #2841, #2909, #2974, #3155, #3165) are each left to their own review; phase 1 needs none and blocks none. Whichever lands second rebases. Before adding the `coordinator` surface, mode and origin names, the implementation checks main for a name already taken. | proposed, G0 |
