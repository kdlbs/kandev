...
- Browser console history follows `REQ-PLATFORM-BROWSER-CONSOLE-RETENTION-001`;
  it is browser-local for three UTC days, subject to entry/byte caps, and is
  not server-persistent before capture.
