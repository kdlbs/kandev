...
owners:
  - kandev
---
# Recoverable Cross-Task Delivery Requirements
...
### REQ-TASKS-RECOVERABLE-CROSS-TASK-DELIVERY-001: Recoverable Cross-Task Delivery

**Intent:** Preserve the observable task or workflow behavior recorded by the legacy specification.

#### Acceptance criteria

- **AC-TASKS-RECOVERABLE-CROSS-TASK-DELIVERY-001.1:** When a consumer uses this capability, the system shall provide the observable behavior and exclusions documented below.
