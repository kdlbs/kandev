...
layouts, the card menu trigger, picker trigger, and picker items use at least a
44 CSS-pixel hit target while the desktop layout keeps its compact controls.
