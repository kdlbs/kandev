...
Open the save form after the Views drawer completes its close/focus callback. Cancel pending opening work on unmount and retain the initiating control for focus return when the form closes.
