...
The UI system owns desktop and mobile web presentation, responsive behavior, and
reusable presentation preferences, including task-listing modes, Home
destination choices, and reusable client-side task navigation. Other systems
retain task, runtime, and workspace lifecycle/state ownership.
...
- [Markdown File Editing](requirements/markdown-file-editing.md)
