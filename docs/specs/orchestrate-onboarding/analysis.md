# Orchestrate Onboarding Analysis
...
- Empty orchestrate dashboard shows zeros everywhere

## What's needed

### CEO agent is not optional
Every orchestrate workspace needs a CEO agent to function. Auto-creating it with sensible defaults reduces friction.
