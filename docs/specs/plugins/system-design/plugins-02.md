...
| `ListWorkflowSteps`     | `api_read:workflows`         | Steps for a workflow (id, name, position, stage type, color, `is_start_step`, `wip_limit`, `agent_profile_id`, `on_enter_action_types`)                                                                                                          |
