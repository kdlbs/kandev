# Office Frontend Hardcoded Logic Audit
...
| priorityToNumber() conversion | new-task-dialog.tsx | Backend accepts string priority |
...
| Page titles | office-topbar.tsx | OK as frontend concern |
| Color palette options | create-project-dialog.tsx | OK as frontend concern |

### Implementation approach

1. Create `GET /api/v1/office/meta` endpoint returning ALL metadata in one call
2. Cache in Zustand store on app init (office layout SSR fetch)
