...
// Exposed on Capabilities directly (not just Manifest) so a host can gate
// requests from a plugin's currently-registered capability snapshot without
// retaining the full Manifest.
