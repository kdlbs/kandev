...
import (
	...
	pluginv1 "github.com/kdlbs/kandev/pluginsdk/proto/kandev/plugin/v1"
...
// gating and the real service-layer calls live in the implementation the
// host provides, not here — this adapter
